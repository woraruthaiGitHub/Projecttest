    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            if ($result->num_rows > 0) {
                ...
                echo "<h3>ข้อมูลการเพิ่มสิทธิ์ของพนักงาน</h3>";
                echo "<table>
                        <tr>
                            <th>ลำดับ</th>
                            <th>ชื่อสิทธิ์</th>
                ...
                while ($row = $result->fetch_assoc()) {
                    if ($row["ActionType"] === "เพิ่มสิทธิ์") { // เฉพาะการเพิ่ม
                        ...
                        echo "<td>" . ($row["Start"] ? convertToThaiDate($row["Start"]) : '-') . "</td>";
                        echo "<td>" . ($row["End"] ? convertToThaiDate($row["End"]) : '-') . "</td>";
                ...
                echo "<h3>ข้อมูลการลบสิทธิ์ของพนักงาน</h3>";
                echo "<table>
                        <tr>
                            <th>ลำดับ</th>
                            <th>ชื่อสิทธิ์</th>
                ...
                while ($row = $result->fetch_assoc()) {
                    if ($row["ActionType"] === "ลบสิทธิ์") { // เฉพาะการลบ
                        ...
                        echo "<td>" . $index++ . "</td>"; // แสดงลำดับ
                        echo "<td>" . htmlspecialchars($row["TaskName"]) . "</td>";
                        echo "<td>" . ($row["DeletedAt"] ? convertToThaiDate($row["DeletedAt"]) : '-') . "</td>";
                        echo "<td>" . htmlspecialchars($row["Status"]) . "</td>";
                        echo "<td>" . htmlspecialchars($row["ActionType"]) . "</td>";
                        echo "</tr>";
                    }
