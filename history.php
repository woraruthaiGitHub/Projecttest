...
<h1>ประวัติการเข้าสู่ระบบ</h1>
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">ประวัติการเข้าใช้</li>
    </ol>
  </nav>
</div><!-- End Page Title -->
    ...
    <tr>
        ...
        <th>ชื่อผู้ใช้</th>
        <th>สถานะ</th>
        <th>วันที่</th> <!-- คอลัมน์วันที่ -->
        <th>เวลา</th>  <!-- คอลัมน์เวลา -->
    ...
    while ($row = $log_result->fetch_assoc()) {
        ...
        $date = $date_time->format('Y-m-d'); // วันที่
        ...
        echo "<td>" . htmlspecialchars($date) . "</td>"; // แสดงวันที่
        echo "<td>" . htmlspecialchars($time) . "</td>"; // แสดงเวลา
        echo "<td><a href='history.php?delete_id=" . htmlspecialchars($row['id']) . "' onclick=\"return confirm('คุณแน่ใจหรือไม่ว่าต้องการลบข้อมูลนี้?');\">ลบ</a></td>"; // ปุ่มลบ
        echo "</tr>";
    }
    ?>
                        </thead>
