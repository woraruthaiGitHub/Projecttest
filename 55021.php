                ...
                <tbody>
                    <?php foreach ($tasks as $index => $task): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars(formatDateThai($task['StartDate'])); ?></td> <!-- แสดงวันที่เริ่มต้นเป็นภาษาไทย -->
                            <td><?php echo htmlspecialchars(formatDateThai($task['EndDate'])); ?></td> <!-- แสดงวันสิ้นสุดเป็นภาษาไทย -->
                            <td><?php echo htmlspecialchars($task['Status']); ?></td> <!-- แสดงสถานะ -->
                            <td>
                                <form action="deleted_tasks.php" method="POST" style="display:inline;">
                                    ...
                                    <button type="submit" class="btn btn-danger" onclick="return confirm('คุณแน่ใจหรือไม่ว่าต้องการลบสิทธิ์นี้?');">ลบ</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
